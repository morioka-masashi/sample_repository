<?php
/* Smarty version 4.3.2, created on 2024-04-15 21:46:33
  from 'C:\xampp\htdocs\mvc_app\Views\home\index.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.2',
  'unifunc' => 'content_661d21a90dbb71_66713963',
...
function content_661d21a90dbb71_66713963 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html>
...
?>
            ...
            <div class="row">
                <div class="col-md-12 col-xs-12 px-0">
                    <dl class="ac">
                        ...
                        <dt class="ac-parent">
                            <h3 class="index_level3">■衛生面に関して</h3>
                        </dt>
                        <dd class="ac-child">
                            <p>・マスクを着用しての接客</p>
                            <p>・出勤前の検温の徹底</p>
                        ...
                        <dt class="ac-parent">
                            <h3 class="index_level3">■お客様へのご協力のお願い</h3>
                        </dt>
                        <dd class="ac-child">
                        ...
                        <dt class="ac-parent">
                            <h3 class="index_level3">■サービスに関して</h3>
                        </dt>
                        <dd class="ac-child">
        ...
        <div class="row menu scroll-block fade-block1">
            ...
            <div class="col-md-6 col-xs-12 right">
                <div class="box-right">
                    サーモンは刺身やカルパッチョで食べるのが美味しいが、ステーキにするのもおすすめだ。和食の焼鮭とは一味違う、リッチな気分になれるサーモンステーキの作り方をマスターしよう。サーモンの美味しさを引き立てる2種のソースも併せて紹介する。
        ...
        <div class="row menu scroll-block fade-block1">
            ...
            <div class="col-md-6 col-xs-12 right">
                <div class="box">
                    <div class="box-right">
                        最もおいしいとされるコーヒー豆を世界中から買い付けています。そして、そのコーヒー豆が持つ個性を最大限に引き出すべく、コーヒー豆の種類に応じたレシピを使用して自社のロースタリーで焙煎しています。
                    </div>
                </div>
            </div>
        </div>
